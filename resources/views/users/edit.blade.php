    ...
    <div class="py-12 bg-gradient-to-br from-indigo-100 via-rose-50 to-purple-100 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-500 mt-2">Perbarui detail profil, email, dan hak akses pengguna di sistem</p>
            </div>
                ...
                <div
                    ...
                    <div class="px-8 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-gray-800 font-bold text-lg">Informasi Akun</h3>
                                <p class="text-gray-500 text-xs">Edit data user {{ $user->name }}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                                <div>
                                    <div class="flex items-center justify-between mb-1.5">
                                        ...
                                        <span class="text-xs text-gray-400 font-light">Kosongkan jika tidak
                                            diubah</span>
                                    </div>
                                    <div class="relative">
                                        <div
                            ...
                            <div class="pt-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select id="role" name="role"
                                        ...
                                        <option value="ADMIN"
                                            {{ ($user->role ?? old('role')) == 'ADMIN' ? 'selected' : '' }}>
                                            <i class="fas fa-shield-alt"></i> ADMIN
                                        </option>
                                        <option value="CLIENT"
                                            {{ ($user->role ?? old('role')) == 'CLIENT' ? 'selected' : '' }}>
                            ...
                            <div class="bg-indigo-50/50 backdrop-blur-sm rounded-xl p-4 border border-indigo-100">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="text-xs text-indigo-700">
                                        ...
                                        <p>User akan tetap menggunakan password lama jika field password dikosongkan.
                                        </p>
                                        <p class="mt-1 text-indigo-600">
                                            <i class="fas fa-id-card mr-1"></i> ID User: {{ $user->id }} |
                                            <i class="fas fa-calendar-alt ml-2 mr-1"></i> Dibuat:
