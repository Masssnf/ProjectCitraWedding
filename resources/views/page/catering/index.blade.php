    ...
    <div class="py-12 bg-gradient-to-br from-indigo-100 via-rose-50 to-purple-100 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-500 mt-2">Kelola paket hidangan pernikahan</p>
            </div>
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Data Catering Baru</h3>
                                    <p class="text-gray-500 text-xs">Tambahkan paket hidangan pernikahan</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                            <form method="POST" action="{{ route('catering.store') }}" class="space-y-4">
                                @csrf
                                <div>
                                    <x-input-label for="type_catering" value="Tipe Catering"
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input type="text" name="type_catering"
                                            ...
                                            required placeholder="Contoh: Prasmanan Nusantara" />
                                    </div>
                                </div>
                                <div>
                                    <x-input-label for="deskripsi" value="Deskripsi Menu"
                                        class="text-gray-700 font-medium mb-1.5 text-xs" />
                                    <div class="relative">
                                        <div
                                        ...
                                        <textarea name="deskripsi" rows="3"
                                            ...
                                            required placeholder="Sebutkan lauk pauk, dessert, dll..."></textarea>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <x-input-label for="porsi" value="Jumlah Porsi"
                                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                                        <div class="relative">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                            ...
                                            <x-text-input type="number" name="porsi" id="create_porsi"
                                                class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-gray-700 text-sm transition-all"
                                                required placeholder="500" />
                                        </div>
                                    </div>
                                    <div>
                                        <x-input-label for="harga" value="Total Harga (Rp)"
                                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                                        <div class="relative">
                                            <div
                                                class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                            ...
                                            <x-text-input type="number" name="harga" id="create_harga"
                                                class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm text-gray-600 transition-all"
                                                readonly placeholder="Otomatis" />
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-indigo-50/50 backdrop-blur-sm rounded-xl p-2">
                                    <p class="text-[11px] text-indigo-600 italic flex items-center">
                                        <i class="fas fa-info-circle mr-1 text-xs"></i>
                                        *Harga dihitung otomatis: Rp 10.000 / Porsi
                                    </p>
                                </div>
                                <div class="pt-3">
                                    <button type="submit"
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Katalog Catering</h3>
                                    <p class="text-gray-500 text-xs">Daftar paket hidangan yang tersedia</p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center gap-2">
                                                    <button type="button"
                                                        ...
                                                        data-modal-target="sourceModal" data-id="{{ $c->id }}"
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-gray-500 font-medium">Belum ada paket catering yang
                                                        terdaftar</p>
        ...
        <div
            ...
            <form method="POST" id="formSourceModal">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        <x-input-label for="modal_type_catering" value="Tipe Catering"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fas fa-tag text-gray-400 text-sm"></i>
                            </div>
                            <x-text-input type="text" id="modal_type_catering" name="type_catering"
                                class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-gray-700 text-sm transition-all" />
                        </div>
                    </div>
                    <div>
                        <x-input-label for="modal_deskripsi" value="Deskripsi Menu"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <x-input-label for="modal_porsi" value="Jumlah Porsi"
                                class="text-gray-700 font-medium mb-1.5 text-xs" />
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <i class="fas fa-users text-gray-400 text-sm"></i>
                                </div>
                                <x-text-input type="number" id="modal_porsi" name="porsi"
                                    class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-gray-700 text-sm transition-all" />
                            </div>
                        </div>
                        <div>
                            <x-input-label for="modal_harga" value="Total Harga (Rp)"
                                class="text-gray-700 font-medium mb-1.5 text-xs" />
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <i class="fas fa-money-bill-wave text-gray-400 text-sm"></i>
...
<script>
    ...
    const editSourceModal = (button) => {
        ...
        document.getElementById('title_source').innerHTML =
            `<i class="fas fa-edit mr-2"></i> Edit: ${type_catering}`;
    ...
    const cateringDelete = (id, type_catering) => {
        Swal.fire({
            title: 'Hapus Data?',
            html: `Paket Catering "<strong>${type_catering}</strong>" akan dihapus permanen!`,
            icon: 'warning',
