    ...
    <div class="py-12 bg-gradient-to-br from-indigo-100 via-rose-50 to-purple-100 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-500 mt-2">Kelola katalog tema dekorasi pernikahan</p>
            </div>
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Data Dekorasi Baru</h3>
                                    <p class="text-gray-500 text-xs">Tambahkan katalog tema dekorasi</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                            <form method="POST" action="{{ route('dekorasi.store') }}" enctype="multipart/form-data"
                                class="space-y-4">
                                @csrf
                                <div>
                                    <x-input-label for="type_dekorasi" value="Tema / Jenis Dekorasi"
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input type="text" name="type_dekorasi"
                                            ...
                                            required placeholder="Contoh: Rustic Minimalis" />
                                    </div>
                                </div>

                                <div>
                                    <x-input-label for="gambar" value="Foto Referensi"
                                        class="text-gray-700 font-medium mb-1.5 text-xs" />
                                    <div class="relative">
                                        <div
                                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        ...
                                        <input type="file" name="gambar" accept="image/*"
                                            class="block w-full pl-10 text-sm text-gray-500 file:mr-2 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-600 hover:file:bg-indigo-100 border border-white/50 bg-white/50 backdrop-blur-sm rounded-xl transition-all cursor-pointer"
                                            required />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea name="deskripsi" rows="3"
                                            ...
                                            required placeholder="Lebar pelaminan, jenis bunga, dll..."></textarea>
                                    </div>
                                </div>
                                <div>
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Katalog Dekorasi</h3>
                                    <p class="text-gray-500 text-xs">Daftar layanan dekorasi beserta portofolio gambar
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div
            ...
            <form method="POST" id="formSourceModal" enctype="multipart/form-data">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        <x-input-label for="modal_type_dekorasi" value="Tema Dekorasi"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fas fa-tag text-gray-400 text-sm"></i>
                            </div>
                            <x-text-input type="text" id="modal_type_dekorasi" name="type_dekorasi"
                                class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-gray-700 text-sm transition-all" />
                        </div>
                    </div>

                    <div>
                        <x-input-label for="modal_gambar" value="Ganti Foto (Opsional)"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fas fa-image text-gray-400 text-sm"></i>
                        ...
                        <p class="text-[10px] text-indigo-400 italic mt-1 flex items-center">
...
<script>
    ...
    const editSourceModal = (button) => {
        ...
        document.getElementById('title_source').innerHTML =
            `<i class="fas fa-edit mr-2"></i> Edit: ${type_dekorasi}`;
    ...
    const dekorasiDelete = (id, type_dekorasi) => {
        Swal.fire({
            title: 'Hapus Data?',
            html: `Dekorasi "<strong>${type_dekorasi}</strong>" akan dihapus permanen!`,
            icon: 'warning',
