    ...
    <div class="py-12 bg-gradient-to-br from-indigo-100 via-rose-50 to-purple-100 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-500 mt-2">Kelola koleksi busana dan aksesoris pengantin</p>
            </div>
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Data Wardrobe Baru</h3>
                                    <p class="text-gray-500 text-xs">Tambahkan koleksi busana pengantin</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                            <form method="POST" action="{{ route('wardrobe.store') }}" class="space-y-4">
                                @csrf
                                <div>
                                    <x-input-label for="type_wardrobe" value="Tipe Busana"
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input type="text" name="type_wardrobe"
                                            ...
                                            required placeholder="Contoh: Kebaya Akad Tradisional" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea name="deskripsi" rows="3"
                                            ...
                                            required placeholder="Jelaskan warna, bahan, atau ukuran..."></textarea>
                                    </div>
                                </div>
                                <div>
                                    <x-input-label for="harga" value="Harga / Nilai Sewa"
                                        class="text-gray-700 font-medium mb-1.5 text-xs" />
                                    <div class="relative">
                                        <div
                                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Katalog Wardrobe</h3>
                                    <p class="text-gray-500 text-xs">Daftar inventaris busana dan kelengkapannya</p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td colspan="5" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-gray-500 font-medium">Belum ada koleksi wardrobe
                                                        yang terdaftar</p>
                                                    <p class="text-gray-400 text-sm mt-1">Klik form di samping untuk
                                                        menambahkan wardrobe</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
        ...
        <div
            ...
            <form method="POST" id="formSourceModal">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        <x-input-label for="modal_type_wardrobe" value="Tipe Busana"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fas fa-tag text-gray-400 text-sm"></i>
                            </div>
                            <x-text-input type="text" id="modal_type_wardrobe" name="type_wardrobe"
                                class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-gray-700 text-sm transition-all" />
                        </div>
                    </div>
                    <div>
...
<script>
    ...
    const editSourceModal = (button) => {
        ...
        document.getElementById('title_source').innerHTML =
            `<i class="fas fa-edit mr-2"></i> Edit: ${type_wardrobe}`;
    ...
    const wardrobeDelete = (id, type_wardrobe) => {
        Swal.fire({
            title: 'Hapus Data?',
            html: `Wardrobe "<strong>${type_wardrobe}</strong>" akan dihapus permanen!`,
            icon: 'warning',
