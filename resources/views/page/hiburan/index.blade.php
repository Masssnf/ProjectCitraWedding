    ...
    <div class="py-12 bg-gradient-to-br from-indigo-100 via-rose-50 to-purple-100 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-gray-500 mt-2">Kelola paket entertainment / hiburan untuk acara pernikahan</p>
            </div>
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Data Hiburan Baru</h3>
                                    <p class="text-gray-500 text-xs">Tambahkan paket entertainment / hiburan acara</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                            <form method="POST" action="{{ route('hiburan.store') }}" class="space-y-4">
                                @csrf
                                <div>
                                    <x-input-label for="type_hiburan" value="Jenis Hiburan"
                                    ...
                                    <div class="relative">
                                        ...
                                        <x-text-input type="text" name="type_hiburan"
                                            ...
                                            required placeholder="Contoh: Akustik Band" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <textarea name="deskripsi" rows="3"
                                            ...
                                            required placeholder="Jelaskan formasi pemain, alat musik, atau durasi main..."></textarea>
                                    </div>
                                </div>
                                <div>
                    ...
                    <div
                        ...
                        <div class="px-6 py-5 border-b border-white/30 bg-gradient-to-r from-white/30 to-transparent">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h3 class="text-gray-800 font-bold text-lg">Katalog Hiburan</h3>
                                    <p class="text-gray-500 text-xs">Daftar layanan hiburan yang tersedia untuk acara
                                    </p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td colspan="5" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-gray-500 font-medium">Belum ada paket hiburan yang
                                                        terdaftar</p>
        ...
        <div
            ...
            <form method="POST" id="formSourceModal">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        <x-input-label for="modal_type_hiburan" value="Jenis Hiburan"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fas fa-tag text-gray-400 text-sm"></i>
                            </div>
                            <x-text-input type="text" id="modal_type_hiburan" name="type_hiburan"
                                class="block w-full pl-10 border-white/50 bg-white/50 backdrop-blur-sm rounded-xl shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 text-gray-700 text-sm transition-all" />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <x-input-label for="modal_harga" value="Harga Sewa (Rp)"
                            class="text-gray-700 font-medium mb-1.5 text-xs" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <i class="fas fa-money-bill-wave text-gray-400 text-sm"></i>
...
<script>
    ...
    const hiburanDelete = (id, type_hiburan) => {
        Swal.fire({
            title: 'Hapus Data?',
            html: `Paket Hiburan "<strong>${type_hiburan}</strong>" akan dihapus permanen!`,
            icon: 'warning',
