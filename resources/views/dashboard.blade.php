<x-app-layout>
    ...
    <div
        class="py-12 bg-gradient-to-br from-indigo-100 via-rose-50 to-purple-100 min-h-screen relative overflow-hidden">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-start space-x-4">
                                                        <div class="relative mt-1">
                                                            ...
                                                            @if (!$loop->last)
                                                                <div
                                                                    class="absolute top-3 left-1.5 w-0.5 h-16 bg-gradient-to-b from-indigo-300 to-transparent">
                                                                </div>
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div>
                                                            <p class="text-gray-800 font-semibold">
                                                                ...
                                                                @if(optional($acara->client)->namapr)
                                                                    & {{ $acara->client->namapr }}
                                                                @endif
                                                            </p>
                                                            ...
                                                            <div class="flex items-start mt-1.5">
                                                                <i
                                                                    class="fas fa-map-marker-alt text-rose-400 mt-0.5 mr-1.5 text-[10px]"></i>
                                                                <p class="text-gray-500 text-xs leading-tight">
                                                                    {{ Str::limit($acara->lokasi_acara ?? 'Lokasi acara belum ditentukan', 50) }}
                                                                </p>
                                                            </div>
                                                    ...
                                                    <div class="text-right flex flex-col items-end justify-center">
                                                        ...
                                                        <p
                                                            class="text-indigo-500 text-xs mt-2 opacity-0 group-hover/item:opacity-100 transition-opacity">
